  ...
  try {
                ...
                if (parsedChunk.name === "fetch_metadata") {
                  try {
                    const filters = {
                      ...
                      complexity: parsedChunk.input.complexity
                    };
    ...
    let newChatEntry = {
        ...
        "chatbot": JSON.stringify({
            "tool_use": toolUse.length > 0 ? toolUse[toolUse.length - 1] : null,
            "tool_result": toolResponse ? {
                "tool_use_id": toolResponse.content[0].tool_use_id,
                "content": toolResponse.content[0].content
            } : null,

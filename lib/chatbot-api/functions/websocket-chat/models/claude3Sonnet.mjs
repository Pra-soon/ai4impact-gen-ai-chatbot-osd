      ...
      "tools": [
        {
           ...
           {
        "name": "fetch_metadata",
        "description": "Retrieve memo metadata to check for updates or changes to policies and procedures",
        "input_schema": {
            "type": "object",
            "properties": {
                "filter_key": {
                    "type": "string",
                    "description": "Topic or keyword to search for in memos (e.g., 'laptops', 'procurement process')"
                }
            },
            "required": ["query"]
        }
